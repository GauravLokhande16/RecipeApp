...
const RecipeInfoPage = () => {
  ...
  const fetchData = () => {
    fetch("https://recipe-app-backend-1wcb.onrender.com/api/recipe/" + id)
      .then((res) => res.json())
      .then((json) => {
  ...
  const checkForLike = () => {
    fetch("https://recipe-app-backend-1wcb.onrender.com/api/favorite/" + id)
      .then((res) => res.json())
      .then((json) => {
  ...
  const likeRecipe = async (id) => {
    const response = await fetch(
      "https://recipe-app-backend-1wcb.onrender.com/api/favorite",
      {
  ...
  const disLike = async () => {
    const response = await fetch(
      "https://recipe-app-backend-1wcb.onrender.com/api/favorite/" + id,
      {
